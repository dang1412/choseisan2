...
// Setup Controller
choseisanApp.controller('createEventController', ['$scope', '$stateParams', '$firebaseObject', 'growl', '$timeout', createEventController])
  .controller('answerEventController', ['$scope', '$stateParams', '$firebaseObject', '$firebaseArray',
      'growl', 'User', 'uiGmapGoogleMapApi', 'uiGmapIsReady', '$timeout', answerEventController])
...
function createEventController ($scope, $stateParams, $firebaseObject, growl, $timeout) {
...
function answerEventController ($scope, $stateParams, $firebaseObject, $firebaseArray, growl, User, uiGmapGoogleMapApi, uiGmapIsReady, $timeout) {
